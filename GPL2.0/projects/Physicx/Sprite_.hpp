...
public:
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary>	Cria o sprite <see cref="Sprite_"/>. </summary>
	////////////////////////////////////////////////////////////////////////////////////////////////////
	Sprite_(void);

	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary>	Deleta o sprite <see cref="Sprite_"/>. </summary>
	////////////////////////////////////////////////////////////////////////////////////////////////////
	~Sprite_(void);
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	void draw(float &x, float &y, float scaleX = 1.0, float scaleY = 1.0, int pivotX = 0, int pivotY = 0, unsigned int alpha = 255, unsigned int angle = 0, bool edge = false);
	//void draw(float  x, float  y, float scaleX = 1.0, float scaleY = 1.0, int pivotX = 0, int pivotY = 0, unsigned int alpha = 255, unsigned int angle = 0, bool edge = false);
	...
	///
	///
	/// <param name="_sprite">	Sprite_ a ser verificada se houve colisão. </param>
	///
	/// <returns> se houve colisão retorna true, caso contrário retorna falso</returns>
	////////////////////////////////////////////////////////////////////////////////////////////////////
	bool collides(Sprite_ _sprite);
